export default {
    fetchValueStream: 'FETCH_VALUE_STREAM',
    fetchValueStreamSuccess: 'FETCH_VALUE_STREAM_SUCCESS',

    fetchValueStreamMembers: 'FETCH_VALUE_STREAM_MEMBERS',
    fetchValueStreamMembersSuccess: 'FETCH_VALUE_STREAM_MEMBERS_SUCCESS',
    ...
    updateStepsSuccess: 'UPDATE_STEPS_SUCCESS',

    deleteValueStream: 'DELETE_VALUE_STREAM',
